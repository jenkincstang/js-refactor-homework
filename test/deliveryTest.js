...
deliveryDateTest("deliveryDateTest: test deliveryState=CT and isRush is false",t => {
  let anOrder = {deliveryState:'CT', placedOn:{plusDays:function (deliveryTime) {
        return deliveryTime;
      }}};
  t.is(deliveryDate(anOrder,false),4)
...
deliveryDateTest("deliveryDateTest: test deliveryState=NY and isRush is false",t => {
  let anOrder = {deliveryState:'NY', placedOn:{plusDays:function (deliveryTime) {
        return deliveryTime;
      }}};
  t.is(deliveryDate(anOrder,false),4)
...
deliveryDateTest("deliveryDateTest: test deliveryState=MH and isRush is false",t => {
  let anOrder = {deliveryState:'NH', placedOn:{plusDays:function (deliveryTime) {
        return deliveryTime;
      }}};
  t.is(deliveryDate(anOrder,false),5)
